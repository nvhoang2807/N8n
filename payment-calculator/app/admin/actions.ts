...
/** Cập nhật dự án theo cấu hình mới trong code (data/), giữ thứ tự và trạng thái ẩn/hiện hiện tại */
export async function updateDefaultProjectAction(id: string): Promise<void> {
  await requireAdmin();
